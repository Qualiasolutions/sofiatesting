...
export const DiceIcon = ({ size = 16 }: { size?: number }) => {
  return (
    ...
    >
      <path
        clipRule="evenodd"
        d="M3 1C1.89543 1 1 1.89543 1 3V5C1 6.10457 1.89543 7 3 7H5C6.10457 7 7 6.10457 7 5V3C7 1.89543 6.10457 1 5 1H3ZM3.5 3.5C3.22386 3.5 3 3.27614 3 3C3 2.72386 3.22386 2.5 3.5 2.5C3.77614 2.5 4 2.72386 4 3C4 3.27614 3.77614 3.5 3.5 3.5ZM4.5 5.5C4.77614 5.5 5 5.27614 5 5.5C5 5.77614 4.77614 6 4.5 6C4.22386 6 4 5.77614 4 5.5C4 5.27614 4.22386 5.5 4.5 5.5ZM11 1C9.89543 1 9 1.89543 9 3V5C9 6.10457 9.89543 7 11 7H13C14.1046 7 15 6.10457 15 5V3C15 1.89543 14.1046 1 13 1H11ZM11.5 3.5C11.2239 3.5 11 3.27614 11 3C11 2.72386 11.2239 2.5 11.5 2.5C11.7761 2.5 12 2.72386 12 3C12 3.27614 11.7761 3.5 11.5 3.5ZM12.5 5.5C12.7761 5.5 13 5.27614 13 5.5C13 5.77614 12.7761 6 12.5 6C12.2239 6 12 5.77614 12 5.5C12 5.27614 12.2239 5.5 12.5 5.5ZM3 9C1.89543 9 1 9.89543 1 11V13C1 14.1046 1.89543 15 3 15H5C6.10457 15 7 14.1046 7 13V11C7 9.89543 6.10457 9 5 9H3ZM4 11.5C4 11.2239 3.77614 11 3.5 11C3.22386 11 3 11.2239 3 11.5C3 11.7761 3.22386 12 3.5 12C3.77614 12 4 11.7761 4 11.5ZM4 12.5C4 12.7761 3.77614 13 3.5 13C3.22386 13 3 12.7761 3 12.5C3 12.2239 3.22386 12 3.5 12C3.77614 12 4 12.2239 4 12.5ZM11 9C9.89543 9 9 9.89543 9 11V13C9 14.1046 9.89543 15 11 15H13C14.1046 15 15 14.1046 15 13V11C15 9.89543 14.1046 9 13 9H11ZM11 11.5C11 11.2239 11.2239 11 11.5 11C11.7761 11 12 11.2239 12 11.5C12 11.7761 11.7761 12 11.5 12C11.2239 12 11 11.7761 11 11.5ZM12 12.5C12 12.2239 11.7761 12 11.5 12C11.2239 12 11 12.2239 11 12.5C11 12.7761 11.2239 13 11.5 13C11.7761 13 12 12.7761 12 12.5ZM13 12.5C13 12.7761 12.7761 13 12.5 13C12.2239 13 12 12.7761 12 12.5C12 12.2239 12.2239 12 12.5 12C12.7761 12 13 12.2239 13 12.5Z"
        fill="currentColor"
        fillRule="evenodd"
      />
    </svg>
