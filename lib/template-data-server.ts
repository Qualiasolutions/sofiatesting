...
export function getTemplateData(): TemplateData {
  ...
  const templateDefinitions = [
    ...
    { id: "01", name: "Standard Seller Registration", category: "registration", requiredFields: ["Buyer Names", "Property Registration Number", "Property Description", "Viewing Date & Time"] },
    { id: "02", name: "Seller with Marketing Agreement", category: "registration", requiredFields: ["Buyer Names", "Property Registration Number", "Property Description", "Viewing Date & Time", "Marketing Price"] },
    { id: "03", name: "Rental Property Registration", category: "registration", requiredFields: ["Tenant Names", "Property Description", "Viewing Date & Time"] },
    { id: "04", name: "Advanced Seller Registration", category: "registration", requiredFields: ["Buyer Names", "Property Registration Numbers", "Property Description", "Agency Fee", "Payment Percentage", "Owner Entities"] },
    { id: "05", name: "Bank Property Registration", category: "registration", requiredFields: ["Client Name", "Client Phone", "Agent Mobile", "Property Link"] },
    { id: "06", name: "Bank Land Registration", category: "registration", requiredFields: ["Client Name", "Client Phone", "Agent Mobile", "Property Link"] },
    { id: "07", name: "Developer Registration (with Viewing)", category: "registration", requiredFields: ["Client Names", "Viewing Date & Time"] },
    { id: "08", name: "Developer Registration (no Viewing)", category: "registration", requiredFields: ["Client Names"] },

    // Viewing Form Templates (09-12)
    { id: "09", name: "Standard Viewing Form", category: "viewing", requiredFields: ["Date", "Name", "ID Number", "Issued By", "Registration Number", "District", "Municipality", "Locality"] },
    { id: "10", name: "Advanced Viewing Form", category: "viewing", requiredFields: ["Date", "Name", "ID Number", "Issued By", "Registration Number", "District", "Municipality", "Locality"] },
    { id: "11", name: "Property Reservation Form", category: "viewing", requiredFields: ["Date Reservation Fee Received", "Prospective Buyers", "Vendors", "Property Details", "Reservation Fee", "Purchase Price", "Special Conditions"] },
    { id: "12", name: "Property Reservation Agreement", category: "viewing", requiredFields: ["Date Reservation Fee Received", "Prospective Buyer", "Vendor", "Property Details", "Reservation Fee", "Purchase Price", "Agent Name", "Company Name", "Banking Details", "Agreement Date"] },

    // Marketing Agreement Templates (13-15)
    { id: "13", name: "Email Marketing Agreement", category: "marketing", requiredFields: ["Seller Name", "Property Registration Number", "Property Location/Description", "Marketing Price"] },
    { id: "14", name: "Non-Exclusive Marketing Agreement", category: "marketing", requiredFields: ["Date", "Seller Name", "Property Registration Number", "Property Location", "Marketing Price", "Agent Name"] },
    { id: "15", name: "Exclusive Marketing Agreement", category: "marketing", requiredFields: ["Date", "Seller Name", "Country", "Passport Number", "Property Description", "Registration Number", "Marketing Price", "Price in Words", "Start Date"] },

    // Client Communication Templates (16-43)
    { id: "16", name: "Good Client - Email", category: "communication", requiredFields: ["Client Name", "Property Link"] },
    { id: "17", name: "Good Client - WhatsApp", category: "communication", requiredFields: ["Client Name", "Property Link"] },
    { id: "18", name: "Valuation Quote", category: "communication", requiredFields: ["Client Name", "Valuation Fee"] },
    { id: "19", name: "Valuation Request Received", category: "communication", requiredFields: ["Client Name"] },
    { id: "20", name: "Client Not Providing Phone", category: "communication", requiredFields: [] },
    { id: "21", name: "Good Client (Missing Phone)", category: "communication", requiredFields: ["Client Name", "Region", "Property Type Context"] },
    { id: "22", name: "Follow-up - Multiple Properties", category: "communication", requiredFields: ["Client Name", "Location", "Property Link 1", "Property Link 2"] },
    { id: "23", name: "Follow-up - Single Property", category: "communication", requiredFields: ["Client Name", "Property Type", "Location", "Property Link"] },
    { id: "24", name: "Buyer Viewing Confirmation", category: "communication", requiredFields: ["Property Link"] },
    { id: "25", name: "No Options - Low Budget", category: "communication", requiredFields: ["Client Name (Optional)"] },
    { id: "26", name: "Multiple Areas Issue", category: "communication", requiredFields: ["Client Name (Optional)", "City/Region"] },
    { id: "27", name: "Time Wasters - Polite Decline", category: "communication", requiredFields: ["Client Name (Optional)"] },
    { id: "28", name: "Still Looking Follow-up", category: "communication", requiredFields: ["Client Name"] },
    { id: "29", name: "No Agent Cooperation", category: "communication", requiredFields: ["Estate Agent Name"] },
    { id: "30", name: "AML/KYC Record Keeping Procedure", category: "communication", requiredFields: [] },
    { id: "31", name: "Selling Request Received", category: "communication", requiredFields: ["Potential Seller Name"] },
    { id: "32", name: "Recommended Pricing Advice", category: "communication", requiredFields: ["Seller Name", "Recommended Asking Price", "Likely Selling Price Range"] },
    { id: "33", name: "Overpriced Property Decline", category: "communication", requiredFields: ["Seller Name", "Transaction Type"] },
    { id: "34", name: "Property Location Information Request", category: "communication", requiredFields: ["Client Name (Optional)"] },
    { id: "35", name: "Different Regions Request", category: "communication", requiredFields: ["Client Name (Optional)"] },
    { id: "36", name: "Client Follow Up - No Reply Yet", category: "communication", requiredFields: ["Client Name (Optional)"] },
    { id: "37", name: "Plain Request to info@zyprus.com", category: "communication", requiredFields: [] },
    { id: "38", name: "Apology for Extended Delay", category: "communication", requiredFields: ["Client Name (Optional)"] },
    { id: "39", name: "Client Rushing/Insisting - Patience Request", category: "communication", requiredFields: ["Client Name (Optional)"] },
  ];
