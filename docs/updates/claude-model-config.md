...
**Key Identity**: The app is configured as "SOFIA - Zyprus Property Group AI Assistant" and follows strict real estate document generation workflows defined in `../knowledge/sophia-ai-assistant-instructions.md`.

**Telegram Bot Integration**: SOFIA includes a fully functional Telegram bot that handles customer inquiries and maintains conversation history. The web interface serves as an admin panel for testing and monitoring. See `../guides/telegram-bot-setup.md` for complete setup instructions.

**Template System**: 47 professional real estate document templates organized in `../templates/source/v1/` covering registrations, viewing forms, marketing agreements, and client communications with specialized Cyprus real estate knowledge.
...
The AI assistant follows strict operating principles defined in `../knowledge/sophia-ai-assistant-instructions.md`:
...
The core AI behavior is comprehensively documented in `../knowledge/sophia-ai-assistant-instructions.md`:
...
- **Documentation**: Complete setup guide in `../guides/telegram-bot-setup.md`
